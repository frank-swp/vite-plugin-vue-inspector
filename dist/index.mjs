...
function printInstructions(fileName, errorMessage) {
  console.log();
  console.log(
    chalk.red(`Could not open ${path2.basename(fileName)} in the editor.`)
  );
  if (errorMessage) {
  ...
  console.log();
  console.log(
    `To set up the editor integration, add something like ${chalk.cyan("VUE_EDITOR=atom")} to the ${chalk.green(".env.local")} file in your project folder and restart the development server. Learn more: ${chalk.green("https://goo.gl/MMTaZt")}`
  );
  console.log();
}
